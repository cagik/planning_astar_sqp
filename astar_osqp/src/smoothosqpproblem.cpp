...
/*  const auto& ref_point_xy = ref_points_.front();
  (*upper_bounds)[0 * 2] = ref_point_xy.first + bounds_box_[0][0];
  (*upper_bounds)[0 * 2 + 1] = ref_point_xy.second + bounds_box_[0][1];
  (*lower_bounds)[0 * 2] = ref_point_xy.first - bounds_box_[0][2];
  (*lower_bounds)[0 * 2 + 1] = ref_point_xy.second - bounds_box_[0][3]; */
